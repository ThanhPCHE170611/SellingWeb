<%-- 
    Document   : Login
    Created on : Mar 2, 2023, 8:36:16 PM
    Author     : pthanh
--%>
...
<html>
    ...
    <body>
        ...
        <form action="ClientController" method="POST" class="login">
            ...
            <%}%>
            <h5><a href="ClientController?go=register">Register</a></h6>
            <button name="submit" type="submit"style="background-color: yellow; color: black">Login</button>
        </form>
    </body>
</html>
