<%-- 
    Document   : cart.jsp
    Created on : Mar 4, 2023, 12:17:30 PM
    Author     : pthanh
--%>
                ...
                <form action="ClientController" method="post">
                    ...
                    <table class="table table-light table-borderless table-hover text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            ...
                            <% Vector<Product> vec = (Vector<Product>) request.getAttribute("cartlist");%>
                            <% double subtotal = 0;%>
                            <% for (int i = 0; i < vec.size(); i++) {
                                    Product pro = vec.get(i);
                                    subtotal += pro.getPrice() * pro.getQuantity();
                            %>
                            <tr>
                                <td class="align-middle"><img src="<%= pro.getImage()%>" alt="" style="width: 50px;"><%= pro.getPname()%></td>
                                <td class="align-middle">$<%= pro.getPrice()%></td>
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        ...
                                        <input type="text" name="<%= pro.getPid()%>" class="form-control form-control-sm bg-secondary border-0 text-center" value="<%= pro.getQuantity()%>">
                                        <div class="input-group-btn">
                                ...
                                <td class="align-middle">$<%=pro.getPrice() * pro.getQuantity()%></td>
                                <td class="align-middle"><button name="remove" value="<%= pro.getPid() %>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <form action="ClientController" method="post">
                            ...
                            <a href="ClientController?go=showAllCart&cid=<%=cid%>">Show All Cart</a>
                            <%}%>
                            <%}%>
